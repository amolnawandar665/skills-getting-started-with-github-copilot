...
activities = {
    ...
    "Soccer Training": {
        "description": "Join the soccer team for drills, conditioning, and friendly matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["nina@mergington.edu", "alex@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim laps, build endurance, and develop competitive swimming skills",
    ...
    "Art Studio": {
        ...
        "max_participants": 15,
        "participants": ["zoe@mergington.edu", "clara@mergington.edu"]
    },
    "Drama Club": {
        "description": "Practice acting, stagecraft, and put on a school play",
    ...
    "Science Club": {
        "description": "Explore experiments, research projects, and science fair preparation",
